                            ...
                            <c:forEach var="product" items="${pageInfo.list}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a type="button" class="btn bg-olive btn-xs" href="${pageContext.request.contextPath}/product/findById?id=${product.id}">编辑</a>
                                        <a type="button" class="btn bg-olive btn-xs" href="${pageContext.request.contextPath}/product/delete?id=${product.id}">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
